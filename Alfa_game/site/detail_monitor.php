...
<head>
	...
	<link rel="stylesheet" href="css/detail_monitor.css">
</head>
<body>
	<div class="main_grid">
		<header>
		...
		<main>
			<img class="img-1" src="css/img_detail_monitor/<?= $products['photo'] ?>.png" alt="">

			<div class="div_txt">
				<h1><?= $products['name'] ?></h1>
				<h2>Игровой монитор на <?= $products['graphics'] ?></h2>
