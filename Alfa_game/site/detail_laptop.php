...
<head>
	...
	<link rel="stylesheet" href="css/detail_laptops.css">
</head>
<body>
	<div class="main_grid">
		<header>
		...
		<main>
			<img class="img-1" src="css/img_detail_laptop/<?= $products['photo'] ?>.png" alt="">

			<div class="div_txt">
				<h1><?= $products['name'] ?></h1>
				<h2>Игровой ноутбук на <?= $products['graphics'] ?></h2>
